...
// STRICT: Only govt_emp can access this page
if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] !== 'govt_emp') {
...
// Get threat statistics (ALL threats - govt employees need full intel)
$stats_sql = "
    SELECT 
...
logSecurityEvent($conn, $user_id, 'ANALYTICS_VIEW', 'Govt Employee accessed threat intelligence dashboard', $_SERVER['REMOTE_ADDR']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Threat Intelligence Dashboard - Cyber Threat Tracker</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="user_dashboard.php" style="color: #00ffe7; font-weight: bold;">🛡️ GOVT DASHBOARD</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="govt_analytics.php">📊 Threat Intelligence</a></li>
                <li class="nav-item"><a class="nav-link" href="view_threats.php">View Threats</a></li>
...
<div class="container-fluid">
    <h1>🛡️ Government Threat Intelligence Dashboard</h1>
    ...
    <div class="table-container">
        <div class="chart-title">🔴 Current Threat Intelligence</div>
...
<footer class="text-center mt-5 py-3" style="background:#181f2a; color:#00ffe7; border-top:1px solid #00ffe7;">
  &copy; <?php echo date('Y'); ?> Cyber Threat Tracker — Government Intelligence
</footer>
