...
// STRICT: Only analyzer can access this page
if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] !== 'analyzer') {
...
// Get threat statistics (ALL threats - analyzers analyze all)
$stats_sql = "
    SELECT 
...
logSecurityEvent($conn, $user_id, 'ANALYTICS_VIEW', 'Analyzer accessed threat analysis dashboard', $_SERVER['REMOTE_ADDR']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Threat Analysis Dashboard - Cyber Threat Tracker</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="user_dashboard.php" style="color: #00ffe7; font-weight: bold;">🔍 ANALYZER DASHBOARD</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="analyzer_analytics.php">📊 Threat Analysis</a></li>
...
<div class="container-fluid">
    ...
    <div class="table-container">
        <div class="chart-title">🔴 Recent Threats for Analysis</div>
...
<footer class="text-center mt-5 py-3" style="background:#181f2a; color:#00ffe7; border-top:1px solid #00ffe7;">
  &copy; <?php echo date('Y'); ?> Cyber Threat Tracker — Threat Analysis
</footer>
