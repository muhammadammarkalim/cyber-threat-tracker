...
<head>
    ...
    <title>Analytics Dashboard - Cyber Threat Tracker</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="admin_dashboard.php" style="color: #00ffe7; font-weight: bold;">📊 Analytics Dashboard</a>
...
<script>
    ...
    const roleChart = new Chart(roleCtx, {
        type: 'doughnut',
        data: {
            labels: ['Admin', 'Student', 'Analyzer', 'Govt Employee', 'IT/CS'],
            datasets: [{
                data: [
                    <?php echo $user_stats['admin_count'] ?? 0; ?>,
                    <?php echo $user_stats['student_count'] ?? 0; ?>,
                    <?php echo $user_stats['analyzer_count'] ?? 0; ?>,
                    <?php echo $user_stats['govt_count'] ?? 0; ?>,
                    <?php echo $user_stats['it_cs_count'] ?? 0; ?>
                ],
                backgroundColor: [
                    '#ff4444',
                    '#00dd00',
    ...
    // 4. Threats Over Time Line Chart
...
<footer class="text-center mt-5 py-3" style="background:#181f2a; color:#00ffe7; border-top:1px solid #00ffe7;">
  &copy; <?php echo date('Y'); ?> Cyber Threat Tracker — Analytics Dashboard
</footer>
